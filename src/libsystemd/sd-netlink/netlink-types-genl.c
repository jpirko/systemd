...
static const NLAPolicySetUnionElement genl_devlink_param_value_policy_set_union_elements[] = {
        BUILD_UNION_ELEMENT_BY_U8(DEVLINK_PARAM_TYPE_U8, genl_devlink_param_value_u8),
        BUILD_UNION_ELEMENT_BY_U8(DEVLINK_PARAM_TYPE_U16, genl_devlink_param_value_u16),
        BUILD_UNION_ELEMENT_BY_U8(DEVLINK_PARAM_TYPE_U32, genl_devlink_param_value_u32),
        BUILD_UNION_ELEMENT_BY_U8(DEVLINK_PARAM_TYPE_STRING, genl_devlink_param_value_string),
        BUILD_UNION_ELEMENT_BY_U8(DEVLINK_PARAM_TYPE_FLAG, genl_devlink_param_value_flag),
};
...
static const NLAPolicy genl_devlink_policies[] = {
        ...
        [DEVLINK_ATTR_PORT_SPLIT_GROUP]                = BUILD_POLICY(STRING),
